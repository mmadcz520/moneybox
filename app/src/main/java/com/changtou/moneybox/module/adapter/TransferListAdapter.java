...
public class TransferListAdapter extends BaseAdapter
{
    ...
    private TransferListEntity mEntity   = null;
    ...
    public void setData(TransferListEntity entity)
    {
        this.mEntity = entity;
        notifyDataSetChanged();
    }

    public TransferListEntity getData()
    {
        return mEntity;
    }
    ...
    public TransferListEntity.ListEntity getItem(int position)
    {
        ...
        {
            return (TransferListEntity.ListEntity) mEntity.mList.get(position);
        }
        return null;
    }
    ...
    {
        TransferListEntity.ListEntity entity = getItem(position);
        ViewHolder viewHolder;

        if (convertView == null)
        {
            viewHolder = new ViewHolder();
            convertView = mInflater.inflate(R.layout.riches_transfer_list_item, null);
